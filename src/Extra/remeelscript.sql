...
VALUES
	(9000000000000+floor(rand()*1000000000000),'2024-02-17',1,999666,11222333),
    (9000000000000+floor(rand()*1000000000000),'2024-02-17',1,999666,11222333),
    (9000000000000+floor(rand()*1000000000000),'2024-04-25',1,345607,11222333),
    (9000000000000+floor(rand()*1000000000000),'2024-02-22',1,345607,98765432),
    (9000000000000+floor(rand()*1000000000000),'2024-02-27',2,345607,98765432),
    (9000000000000+floor(rand()*1000000000000),'2024-03-01',1,999666,98765432),
    (9000000000000+floor(rand()*1000000000000),'2024-05-12',2,999666,98765432),
    (9000000000000+floor(rand()*1000000000000),'2023-01-01',1,345607,44555666),
    (9000000000000+floor(rand()*1000000000000),'2023-12-25',2,345607,44555666),
    (9000000000000+floor(rand()*1000000000000),'2024-06-21',1,345607,44555666);
